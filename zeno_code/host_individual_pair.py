...
######################## BLIP_base ########################
# read in your data
df_system = pd.read_csv("zeno_code/blip_scores/blipbase.csv")
...
######################## BLIP_large ########################
# read in your data
df_system = pd.read_csv("zeno_code/blip_scores/bliplarge.csv")
...
######################## LLaVa ########################
# read in your data
df_system = pd.read_csv("zeno_code/llava_scores/llava.csv")

# Create an id column to match the base dataset.
df_system["id"] = df_system.index
df_system["Image-and-Text Retrieval"] = df_system["Image Retrieval"] & df_system["Text Retrieval"]
project.upload_system(df_system, name="LLaVa-1.5-13b", id_column="id", output_column="Image-and-Text Retrieval")
